...
var ids = summoner$1.ids = [4];
var modules = summoner$1.modules = {
  102: function(module, exports2, __webpack_require__) {
    ...
    module.exports.__inject__ = function(context) {
      add("6c18eac8", content, true, context);
    };
  },
  103: function(module, exports2, __webpack_require__) {
    ...
    var add = __webpack_require__(6).default;
    module.exports.__inject__ = function(context) {
      add("44ef06e4", content, true, context);
    };
  },
  121: function(module, __webpack_exports__, __webpack_require__) {
    __webpack_require__.r(__webpack_exports__);
    var _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_SummonerInfo_vue_vue_type_style_index_0_id_d4d18f50_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(102);
    for (var __WEBPACK_IMPORT_KEY__ in _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_SummonerInfo_vue_vue_type_style_index_0_id_d4d18f50_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__)
      if (["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0)
        (function(key) {
          __webpack_require__.d(__webpack_exports__, key, function() {
            return _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_SummonerInfo_vue_vue_type_style_index_0_id_d4d18f50_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key];
          });
  ...
  122: function(module, exports2, __webpack_require__) {
    ...
    ___CSS_LOADER_EXPORT___.push([module.i, '/*purgecss start ignore*/\n.top-menu[data-v-d4d18f50]{\n  position:relative;\n  display:block;\n  padding:0 3px;\n  font-size:16px;\n  line-height:19px;\n  font-weight:600;\n  color:#a0a5b6\n}\n.top-menu.nuxt-link-active[data-v-d4d18f50]{\n  padding:0 5px 10px;\n  font-size:17px;\n  line-height:20px;\n  color:#4e41db;\n  border-bottom:2px solid #4e41db\n}\n.header-scrolled[data-v-d4d18f50]{\n  background-color:rgba(42,67,101,.95)\n}\n.discord svg[data-v-d4d18f50]{\n  width:22px;\n  height:22px;\n  transform-origin:bottom left;\n  transition:.2s ease-in-out\n}\n.discord:hover svg[data-v-d4d18f50]{\n  width:24px;\n  height:24px;\n  transform:rotate(-5deg)\n}\n.discord:hover span[data-v-d4d18f50]{\n  color:#ebf8ff\n}\n.playing[data-v-d4d18f50]{\n  position:relative\n}\n.playing[data-v-d4d18f50]:after{\n  content:"";\n  position:absolute;\n  height:4.6rem;\n  width:4.6rem;\n  top:-5px;\n  left:-5px;\n  right:0;\n  bottom:0;\n  border-radius:50%;\n  z-index:0;\n  background:linear-gradient(0deg,transparent 30%,rgba(56,178,172,.8));\n  -webkit-animation:rotate-d4d18f50 .75s linear 0s infinite normal none running;\n          animation:rotate-d4d18f50 .75s linear 0s infinite normal none running\n}\n@-webkit-keyframes rotate-d4d18f50{\nto{\n    transform:rotate(1turn)\n}\n}\n@keyframes rotate-d4d18f50{\nto{\n    transform:rotate(1turn)\n}\n}\n.playing-dot[data-v-d4d18f50]{\n  -webkit-animation:playing-d4d18f50 2.5s ease-in-out 0s infinite normal none running;\n          animation:playing-d4d18f50 2.5s ease-in-out 0s infinite normal none running\n}\n.playing-dot[data-v-d4d18f50],.playing-not-dot[data-v-d4d18f50]{\n  box-shadow:0 0 0 0 #000;\n  transform:scale(1)\n}\n.playing-not-dot[data-v-d4d18f50]{\n  -webkit-animation:playing-not-d4d18f50 2.5s ease-in-out 0s infinite normal none running;\n          animation:playing-not-d4d18f50 2.5s ease-in-out 0s infinite normal none running\n}\n@-webkit-keyframes playing-d4d18f50{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(232,64,87,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n@keyframes playing-d4d18f50{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(232,64,87,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n@-webkit-keyframes playing-not-d4d18f50{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(38,38,38,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n@keyframes playing-not-d4d18f50{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(38,38,38,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n\n/*purgecss end ignore*/', ""]);
    ___CSS_LOADER_EXPORT___.locals = {};
    module.exports = ___CSS_LOADER_EXPORT___;
  },
  123: function(module, __webpack_exports__, __webpack_require__) {
    __webpack_require__.r(__webpack_exports__);
    var _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_summoner_vue_vue_type_style_index_0_id_3995f3fc_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(103);
    for (var __WEBPACK_IMPORT_KEY__ in _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_summoner_vue_vue_type_style_index_0_id_3995f3fc_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__)
      if (["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0)
        (function(key) {
          __webpack_require__.d(__webpack_exports__, key, function() {
            return _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_summoner_vue_vue_type_style_index_0_id_3995f3fc_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key];
          });
        })(__WEBPACK_IMPORT_KEY__);
  },
  124: function(module, exports2, __webpack_require__) {
    var ___CSS_LOADER_API_IMPORT___ = __webpack_require__(5);
    var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(function(i) {
      return i[1];
    });
    ___CSS_LOADER_EXPORT___.push([module.i, '/*purgecss start ignore*/\n.top-menu[data-v-3995f3fc]{\n  position:relative;\n  display:block;\n  padding:0 3px;\n  font-size:16px;\n  line-height:19px;\n  font-weight:600;\n  color:#a0a5b6\n}\n.top-menu.nuxt-link-active[data-v-3995f3fc]{\n  padding:0 5px 10px;\n  font-size:17px;\n  line-height:20px;\n  color:#ff9600;\n  border-bottom:2px solid #ff9600\n}\n.header-scrolled[data-v-3995f3fc]{\n  background-color:rgba(42,67,101,.95)\n}\n.discord svg[data-v-3995f3fc]{\n  width:22px;\n  height:22px;\n  transform-origin:bottom left;\n  transition:.2s ease-in-out\n}\n.discord:hover svg[data-v-3995f3fc]{\n  width:24px;\n  height:24px;\n  transform:rotate(-5deg)\n}\n.discord:hover span[data-v-3995f3fc]{\n  color:#ebf8ff\n}\n.playing[data-v-3995f3fc]{\n  position:relative\n}\n.playing[data-v-3995f3fc]:after{\n  content:"";\n  position:absolute;\n  height:4.6rem;\n  width:4.6rem;\n  top:-5px;\n  left:-5px;\n  right:0;\n  bottom:0;\n  border-radius:50%;\n  z-index:0;\n  background:linear-gradient(0deg,transparent 30%,rgba(56,178,172,.8));\n  -webkit-animation:rotate-3995f3fc .75s linear 0s infinite normal none running;\n          animation:rotate-3995f3fc .75s linear 0s infinite normal none running\n}\n@-webkit-keyframes rotate-3995f3fc{\nto{\n    transform:rotate(1turn)\n}\n}\n@keyframes rotate-3995f3fc{\nto{\n    transform:rotate(1turn)\n}\n}\n.playing-dot[data-v-3995f3fc]{\n  -webkit-animation:playing-3995f3fc 2.5s ease-in-out 0s infinite normal none running;\n          animation:playing-3995f3fc 2.5s ease-in-out 0s infinite normal none running\n}\n.playing-dot[data-v-3995f3fc],.playing-not-dot[data-v-3995f3fc]{\n  box-shadow:0 0 0 0 #000;\n  transform:scale(1)\n}\n.playing-not-dot[data-v-3995f3fc]{\n  -webkit-animation:playing-not-3995f3fc 2.5s ease-in-out 0s infinite normal none running;\n          animation:playing-not-3995f3fc 2.5s ease-in-out 0s infinite normal none running\n}\n@-webkit-keyframes playing-3995f3fc{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(232,64,87,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n@keyframes playing-3995f3fc{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(232,64,87,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n@-webkit-keyframes playing-not-3995f3fc{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(38,38,38,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n@keyframes playing-not-3995f3fc{\n0%{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 rgba(38,38,38,.7)\n}\n70%{\n    transform:scale(1);\n    box-shadow:0 0 0 8px transparent\n}\nto{\n    transform:scale(.95);\n    box-shadow:0 0 0 0 transparent\n}\n}\n\n/*purgecss end ignore*/', ""]);
    ___CSS_LOADER_EXPORT___.locals = {};
    module.exports = ___CSS_LOADER_EXPORT___;
  },
  159: function(module, __webpack_exports__, __webpack_require__) {
    ...
    var render = function render2() {
      ...
      return _c("div", {
        class: {
          "page-wrapper mx-auto": _vm.$device.isDesktop
        }
      }, [!_vm.summonerFound && _vm.summonerNotFound ? _vm._ssrNode('<div class="mx-auto py-20 text-center text-c-0" data-v-3995f3fc>', "</div>", [_vm._ssrNode('<h2 class="text-lg py-4" data-v-3995f3fc>ZEM.GG\uC5D0 \uB4F1\uB85D\uB418\uC9C0 \uC54A\uC740 \uC18C\uD658\uC0AC\uC785\uB2C8\uB2E4. \uC624\uD0C0\uB97C \uD655\uC778 \uD6C4 \uB2E4\uC2DC \uAC80\uC0C9\uD574\uC8FC\uC138\uC694.</h2> <div data-v-3995f3fc>\n      \u02A2\xB4\u2022 \u1D25 \u2022`\u02A1\n    </div>')], 2) : _vm._ssrNode("<div data-v-3995f3fc>", "</div>", [_vm.$device.isDesktop ? [_vm._ssrNode('<div class="relative z-10 w-full" data-v-3995f3fc>', "</div>", [_vm.summonerLoading || _vm.summonerFound ? [_vm._ssrNode('<div class="flex flex-col items-start mt-4 p-2" data-v-3995f3fc>', "</div>", [_vm.summonerLoading ? [_c("HeaderLoader")] : _vm.summonerFound ? [_vm._ssrNode('<div class="flex justify-between items-center w-full" data-v-3995f3fc>', "</div>", [_c("SummonerInfo"), _vm._ssrNode(" "), Object.entries(_vm.ranked).length !== 0 ? _c("SummonerRanked", {
        attrs: {
          "ranked": _vm.ranked
        }
      }) : _vm._e()], 2), _vm._ssrNode(" "), _vm._ssrNode('<div class="flex gap-2 text-c-0 mt-4" data-v-3995f3fc>', "</div>", [_c("nuxt-link", {
        staticClass: "top-menu",
        class: {
          "nuxt-link-exact-active nuxt-link-active": _vm.$route.params.mode
        },
        attrs: {
          "to": {
      ...
      }, [_vm._v("\uC885\uD569")]), _vm._ssrNode(" "), _c("nuxt-link", {
        staticClass: "top-menu",
        attrs: {
          "to": {
      ...
      }, [_vm._v("\uCC54\uD53C\uC5B8")]), _vm._ssrNode(" "), _c("nuxt-link", {
        staticClass: "top-menu",
        attrs: {
          "to": {
      ...
      }, [_vm._v("\uCC54\uD53C\uC5B8 \uAE30\uB85D\uC2E4")])], 2)] : _vm._e()], 2)] : _vm._e()], 2), _vm._ssrNode(" "), _vm._ssrNode('<div class="relative z-10" data-v-3995f3fc>', "</div>", [_c("transition", {
        attrs: {
          "name": _vm.tabTransition
        }
      }, [_c("nuxt")], 1)], 1)] : _vm._e(), _vm._ssrNode(" "), _vm.$device.isMobile ? [_vm._ssrNode('<div class="relative z-10 w-full" data-v-3995f3fc>', "</div>", [_vm.summonerLoading || _vm.summonerFound ? [_vm.summonerLoading ? [_c("HeaderLoader")] : _vm.summonerFound ? [_c("SummonerInfo"), _vm._ssrNode(" "), _vm._ssrNode('<div class="flex items-center justify-between mt-4 p-2" data-v-3995f3fc>', "</div>", [_vm._ssrNode('<div class="flex gap-2 text-c-0" data-v-3995f3fc>', "</div>", [_c("nuxt-link", {
        staticClass: "top-menu",
        class: {
          "nuxt-link-exact-active nuxt-link-active": _vm.$route.params.mode
        },
      ...
      }, [_vm._v("\uCC54\uD53C\uC5B8 \uAE30\uB85D\uC2E4")])], 2)])] : _vm._e()] : _vm._e()], 2), _vm._ssrNode(" "), _vm._ssrNode('<div class="relative z-10w-full mx-auto mt-3 mb-8" data-v-3995f3fc>', "</div>", [_c("transition", {
        attrs: {
          "name": _vm.tabTransition
        }
      }, [_c("nuxt")], 1)], 1)] : _vm._e()], 2)]);
    };
    var staticRenderFns = [];
    var vuex = __webpack_require__(2);
    var HeaderLoadervue_type_template_id_52653384_render = function render2() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", {
    ...
    var HeaderLoadervue_type_template_id_52653384_staticRenderFns = [];
    var vue_spinners_common = __webpack_require__(97);
    var HeaderLoadervue_type_script_lang_js_ = {
      components: {
        BounceLoader: vue_spinners_common["BounceLoader"]
      }
    };
    var Summoner_HeaderLoadervue_type_script_lang_js_ = HeaderLoadervue_type_script_lang_js_;
    var componentNormalizer = __webpack_require__(1);
    var component = Object(componentNormalizer["a"])(Summoner_HeaderLoadervue_type_script_lang_js_, HeaderLoadervue_type_template_id_52653384_render, HeaderLoadervue_type_template_id_52653384_staticRenderFns, false, null, null, "2835c213");
    var HeaderLoader = component.exports;
    var SummonerInfovue_type_template_id_d4d18f50_scoped_true_render = function render2() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", {
        staticClass: "px-2 py-2"
      }, [_vm.$device.isDesktop ? [_vm._ssrNode('<div class="relative z-10 w-full" data-v-d4d18f50>', "</div>", [_vm.summonerLoading || _vm.summonerFound ? [_vm._ssrNode("<div data-v-d4d18f50>", "</div>", [_vm._ssrNode('<div class="flex items-center justify-between w-full" data-v-d4d18f50>', "</div>", [_c("nuxt-img", {
        staticClass: "rounded-lg",
        attrs: {
          "src": `https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/profile-icons/${_vm.basic.account.profileIconId}.jpg`,
          "format": "webp",
          "width": "80",
          "height": "80"
        }
      }), _vm._ssrNode(' <div class="flex flex-col ml-2 flex-1" data-v-d4d18f50><div class="flex items-center justify-between w-full" data-v-d4d18f50><div class="text-xs text-c-3 font-gong" data-v-d4d18f50>' + _vm._ssrEscape("\uB808\uBCA8 " + _vm._s(_vm.basic.account.summonerLevel)) + '</div> <div class="flex ml-4 mb-1" data-v-d4d18f50><button' + _vm._ssrClass("flex items-center px-2 py-1 text-xs rounded-sm border cursor-pointer select-none", _vm.isFavorite(_vm.basic.account.name) ? "border-c-3 bg-c-3 text-white" : "bg-white border-c-0 text-c-0") + ' data-v-d4d18f50><svg class="w-3p5 h-3p5" data-v-d4d18f50><use xlink:href="#star" data-v-d4d18f50></use></svg></button></div></div> <h2 class="flex items-end font-bold" data-v-d4d18f50><span class="text-5xl font-gong text-c-3" data-v-d4d18f50>' + _vm._ssrEscape(_vm._s(_vm.basic.account.name[0])) + '</span> <span class="text-3xl font-gong text-c-0" data-v-d4d18f50>' + _vm._ssrEscape(_vm._s(_vm.basic.account.name.substring(1))) + "</span></h2></div>")], 2)])] : _vm._e()], 2)] : _vm._e(), _vm._ssrNode(" "), _vm.$device.isMobile ? [_vm._ssrNode('<div class="relative z-10 w-full" data-v-d4d18f50>', "</div>", [_vm.summonerLoading || _vm.summonerFound ? [_vm._ssrNode("<div data-v-d4d18f50>", "</div>", [_vm._ssrNode('<div class="flex items-center justify-between w-full" data-v-d4d18f50>', "</div>", [_c("nuxt-img", {
        staticClass: "rounded-lg",
        attrs: {
          "src": `https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/profile-icons/${_vm.basic.account.profileIconId}.jpg`,
          "format": "webp",
    ...
    var SummonerInfovue_type_template_id_d4d18f50_scoped_true_staticRenderFns = [];
    var SummonerInfovue_type_script_lang_js_ = {
      components: {},
      data() {
        return {
          bgHeader: false
      ...
      beforeMount() {
        this.updateSettings({
          name: "region",
          value: this.$route.params.region.toLowerCase()
        });
      },
      destroyed() {
      },
      methods: {
        ...
        ...Object(vuex["b"])("settings", ["updateSettings", "updateFavorite"]),
        ...Object(vuex["b"])("summoner", ["basicRequest"])
      }
    };
    var Summoner_SummonerInfovue_type_script_lang_js_ = SummonerInfovue_type_script_lang_js_;
    function injectStyles(context) {
      var style0 = __webpack_require__(121);
      if (style0.__inject__)
        style0.__inject__(context);
    }
    var SummonerInfo_component = Object(componentNormalizer["a"])(Summoner_SummonerInfovue_type_script_lang_js_, SummonerInfovue_type_template_id_d4d18f50_scoped_true_render, SummonerInfovue_type_template_id_d4d18f50_scoped_true_staticRenderFns, false, injectStyles, "d4d18f50", "56f54e2f");
    var SummonerInfo = SummonerInfo_component.exports;
    var SummonerRanked = __webpack_require__(99);
    var summonervue_type_script_lang_js_ = {
    ...
    var pages_summonervue_type_script_lang_js_ = summonervue_type_script_lang_js_;
    function summoner_injectStyles(context) {
      var style0 = __webpack_require__(123);
      if (style0.__inject__)
        style0.__inject__(context);
    }
    var summoner_component = Object(componentNormalizer["a"])(pages_summonervue_type_script_lang_js_, render, staticRenderFns, false, summoner_injectStyles, "3995f3fc", "75992cb8");
    __webpack_exports__["default"] = summoner_component.exports;
  },
...
const summoner = /*#__PURE__*/_mergeNamespaces({
  __proto__: null,
  ids: ids,
  modules: modules,
  'default': summoner$1
...
export { summoner as s };
//# sourceMappingURL=summoner.mjs.map
