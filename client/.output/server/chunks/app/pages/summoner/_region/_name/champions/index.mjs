...
var ids = champions.ids = [6];
var modules = champions.modules = {
  104: function(module, exports2, __webpack_require__) {
    ...
    module.exports.__inject__ = function(context) {
      add("439a9c56", content, true, context);
    };
  },
  125: function(module, __webpack_exports__, __webpack_require__) {
    __webpack_require__.r(__webpack_exports__);
    var _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_ChampionsTable_vue_vue_type_style_index_0_id_712b78e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(104);
    for (var __WEBPACK_IMPORT_KEY__ in _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_ChampionsTable_vue_vue_type_style_index_0_id_712b78e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__)
      if (["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0)
        (function(key) {
          __webpack_require__.d(__webpack_exports__, key, function() {
            return _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_ChampionsTable_vue_vue_type_style_index_0_id_712b78e6_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key];
          });
...
.heading[data-v-712b78e6]{
  box-shadow:none
}
.sorted[data-v-712b78e6]:after{
  content:"";
  position:absolute;
  top:-15px;
  left:0;
...
.sorted-asc[data-v-712b78e6]:after{
  background-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 320 512'%3E%3Cpath d='M288.662 352H31.338c-17.818 0-26.741-21.543-14.142-34.142l128.662-128.662c7.81-7.81 20.474-7.81 28.284 0l128.662 128.662c12.6 12.599 3.676 34.142-14.142 34.142z'/%3E%3C/svg%3E")
}
.sorted-desc[data-v-712b78e6]:after{
  background-image:url("data:image/svg+xml;charset=utf-8,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 320 512'%3E%3Cpath d='M31.3 192h257.3c17.8 0 26.7 21.5 14.1 34.1L174.1 354.8c-7.8 7.8-20.5 7.8-28.3 0L17.2 226.1C4.6 213.5 13.5 192 31.3 192z'/%3E%3C/svg%3E")
}
.w-name[data-v-712b78e6]{
  width:135px
}
.w-kda[data-v-712b78e6]{
  width:90px
}
...
/*purgecss end ignore*/`, ""]);
  ...
  156: function(module, __webpack_exports__, __webpack_require__) {
    __webpack_require__.r(__webpack_exports__);
    var championsvue_type_template_id_3100687f_render = function render() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", [_vm.champions.length ? _vm._ssrNode("<div>", "</div>", [_vm._ssrNode('<div class="flex items-center justify-end space-x-4">', "</div>", [_c("FilterQueue", {
        attrs: {
          "choices": _vm.queues
        },
        on: {
          "filter-queue": _vm.filterByQueue
        }
      })], 1), _vm._ssrNode(" "), _c("ChampionsTable", {
        staticClass: "mt-6",
        attrs: {
          "champions": _vm.champions,
          "search": _vm.searchChampions,
          "only-most-played": _vm.onlyMostPlayed
        }
      })], 2) : _vm._ssrNode("<div>", "</div>", [_c("ChampionsLoader")], 1)]);
    };
    var staticRenderFns = [];
    var vuex = __webpack_require__(2);
    var data = __webpack_require__(16);
    var ChampionsTablevue_type_template_id_712b78e6_scoped_true_render = function render() {
      var _vm = this, _c = _vm._self._c;
      return _c("table", {
        staticClass: "w-full leading-none text-center bg-white border border-teal-400 rounded-sm shadow-sm"
      }, [_vm._ssrNode('<thead data-v-712b78e6><tr class="text-sm select-none text-blue-500 bg-blue-300" data-v-712b78e6><th' + _vm._ssrClass("relative px-2 py-4 font-normal cursor-pointer", _vm.sortedClasses("index")) + " data-v-712b78e6>rank</th> " + _vm._ssrList(_vm.headings, function(heading, index) {
        return "<th" + _vm._ssrClass("relative px-2 py-4 font-normal cursor-pointer", [{
          "w-name": heading.name === "Name",
          "w-kda": heading.name === "KDA"
        }, _vm.sortedClasses(heading.props)]) + " data-v-712b78e6>" + _vm._s(heading.name) + "</th>";
      }) + "</tr></thead> " + (_vm.champions.length ? "<tbody data-v-712b78e6>" + _vm._ssrList(_vm.championsToDisplay, function(champion, index) {
        return "<tr" + _vm._ssrClass("text-blue-500 font-bold", {
          "rounded-b-lg": index === _vm.championsToDisplay.length - 1
        }) + " data-v-712b78e6><td" + _vm._ssrClass("px-2 py-3 text-sm", {
          "rounded-bl-lg": index === _vm.championsToDisplay.length - 1
        }) + " data-v-712b78e6>" + _vm._ssrEscape(_vm._s(champion.index + 1)) + '</td> <td class="px-2 py-3 text-xs w-40" data-v-712b78e6><div class="flex items-center" data-v-712b78e6><div class="flex-shrink-0 w-6 h-6 bg-center bg-cover rounded-full bg-white0"' + _vm._ssrStyle(null, {
          backgroundImage: `url('${champion.champion.icon}')`
        }, null) + ' data-v-712b78e6></div> <div class="ml-2" data-v-712b78e6>' + _vm._ssrEscape(_vm._s(champion.champion.name)) + '</div></div></td> <td class="px-2 py-3 text-sm"' + _vm._ssrStyle(null, _vm.bgColor(champion, "winrate"), null) + " data-v-712b78e6>" + _vm._ssrEscape(_vm._s(_vm._f("percent")(champion.winrate))) + '</td> <td class="px-2 py-3 text-sm"' + _vm._ssrStyle(null, _vm.bgColor(champion, "playrate"), null) + " data-v-712b78e6>" + _vm._ssrEscape(_vm._s(_vm._f("percent")(champion.playrate))) + '</td> <td class="px-2 py-3 text-sm"' + _vm._ssrStyle(null, _vm.bgColor(champion, "wins"), null) + " data-v-712b78e6>" + _vm._ssrEscape(_vm._s(champion.wins)) + '</td> <td class="px-2 py-3 text-sm"' + _vm._ssrStyle(null, _vm.bgColor(champion, "count"), null) + " data-v-712b78e6>" + _vm._ssrEscape(_vm._s(champion.count)) + '</td> <td class="px-2 py-3 text-sm"' + _vm._ssrStyle(null, _vm.bgColor(champion, "kda"), null) + " data-v-712b78e6><div data-v-712b78e6>" + _vm._ssrEscape(_vm._s(_vm._f("round")(champion.kda))) + '</div> <div class="mt-1 whitespace-nowrap text-xxs" data-v-712b78e6>' + _vm._ssrEscape("\n          " + _vm._s(_vm._f("round")(champion.kills / champion.count, 1)) + "\n          /\n          " + _vm._s(_vm._f("round")(champion.deaths / champion.count, 1)) + "\n          /\n          " + _vm._s(_vm._f("round")(champion.assists / champion.count, 1)) + "\n        ") + '</div></td> <td class="px-2 py-3 text-sm"' + _vm._ssrStyle(null, _vm.bgColor(champion, "kp"), null) + " data-v-712b78e6>" + _vm._ssrEscape(_vm._s(_vm._f("percent")(champion.kp))) + "</td> <td" + _vm._ssrClass("px-2 py-3 text-xs", {
          "rounded-br-lg": index === _vm.championsToDisplay.length - 1
        }) + " data-v-712b78e6>" + _vm._ssrEscape(_vm._s(champion.lastPlayed)) + "</td></tr>";
      }) + "</tbody>" : "<!---->"))]);
    };
    var ChampionsTablevue_type_template_id_712b78e6_scoped_true_staticRenderFns = [];
    var vue_runtime = __webpack_require__(0);
    var uid = function() {
      return Math.random().toString(36).substring(2);
    };
    var ContentLoader = Object(vue_runtime["d"])({
      name: "ContentLoader",
      props: {
        width: {
          type: [Number, String]
      ...
      setup: function setup(props) {
        var idClip = Object(vue_runtime["a"])(function() {
          return props.uniqueKey ? "".concat(props.uniqueKey, "-idClip") : uid();
        });
        var idGradient = Object(vue_runtime["a"])(function() {
          return props.uniqueKey ? "".concat(props.uniqueKey, "-idGradient") : uid();
        });
        var width = Object(vue_runtime["a"])(function() {
          var _a;
          return (_a = props.width) !== null && _a !== void 0 ? _a : 400;
        });
        var height = Object(vue_runtime["a"])(function() {
          var _a;
          return (_a = props.height) !== null && _a !== void 0 ? _a : 130;
        });
        var computedViewBox = Object(vue_runtime["a"])(function() {
          var _a;
      ...
      render: function render() {
        return Object(vue_runtime["createVNode"])("svg", {
          "width": this.width,
          "height": this.height,
          "viewBox": this.computedViewBox,
          "version": "1.1",
          "preserveAspectRatio": this.preserveAspectRatio
        }, [Object(vue_runtime["createVNode"])("rect", {
          "style": {
          ...
          "width": "100%",
          "height": "100%"
        }, null), Object(vue_runtime["createVNode"])("defs", null, [Object(vue_runtime["createVNode"])("clipPath", {
          "id": this.idClip
        }, [this.$slots["default"] ? this.$slots["default"]() : Object(vue_runtime["createVNode"])("rect", {
          "x": "0",
          "y": "0",
          "rx": "5",
          "ry": "5",
          "width": "100%",
          "height": "100%"
        }, null)]), Object(vue_runtime["createVNode"])("linearGradient", {
          "id": this.idGradient
        }, [Object(vue_runtime["createVNode"])("stop", {
          "offset": "0%",
          "stop-color": this.primaryColor,
          "stop-opacity": this.primaryOpacity
        }, [this.animate ? Object(vue_runtime["createVNode"])("animate", {
          "attributeName": "offset",
          "values": "-2; 1",
          "dur": "".concat(this.speed, "s"),
          "repeatCount": "indefinite"
        }, null) : null]), Object(vue_runtime["createVNode"])("stop", {
          "offset": "50%",
    ...
    Object(vue_runtime["d"])(function(props, _a) {
      var attrs = _a.attrs;
      return function() {
        return Object(vue_runtime["createVNode"])(ContentLoader, attrs, {
          "default": function _default() {
            return [Object(vue_runtime["createVNode"])("circle", {
              "cx": "10",
              "cy": "20",
              "r": "8"
            }, null), Object(vue_runtime["createVNode"])("rect", {
              "x": "25",
              "y": "15",
              "rx": "5",
              "ry": "5",
              "width": "220",
              "height": "10"
            }, null), Object(vue_runtime["createVNode"])("circle", {
              "cx": "10",
              "cy": "50",
              "r": "8"
            }, null), Object(vue_runtime["createVNode"])("rect", {
    ...
    Object(vue_runtime["d"])(function(props, _a) {
      ...
      return function() {
        return Object(vue_runtime["createVNode"])(ContentLoader, attrs, {
          "default": function _default() {
            return [Object(vue_runtime["createVNode"])("rect", {
              "x": "0",
              "y": "0",
              "rx": "3",
              "ry": "3",
    ...
    Object(vue_runtime["d"])(function(props, _a) {
      var attrs = _a.attrs;
      return function() {
        return Object(vue_runtime["createVNode"])(ContentLoader, Object(vue_runtime["mergeProps"])(attrs, {
          "viewBox": "0 0 400 480"
        }), {
          "default": function _default() {
            return [Object(vue_runtime["createVNode"])("circle", {
    ...
    var ChampionsTablevue_type_script_lang_js_ = {
      components: {
        ContentLoader
      },
      props: {
        ...
        updateChampionsList() {
          this.championsFull = this.champions.map((champ, index) => {
            ...
            return {
              ...
              kda,
              index,
              lastPlayed: Object(functions["e"])(champ.date),
              show: true
            };
          });
        }
    ...
    var Champions_ChampionsTablevue_type_script_lang_js_ = ChampionsTablevue_type_script_lang_js_;
    ...
    var component = Object(componentNormalizer["a"])(Champions_ChampionsTablevue_type_script_lang_js_, ChampionsTablevue_type_template_id_712b78e6_scoped_true_render, ChampionsTablevue_type_template_id_712b78e6_scoped_true_staticRenderFns, false, injectStyles, "712b78e6", "463adc7c");
    var ChampionsTable = component.exports;
    var FilterQueuevue_type_template_id_0b5d1d9e_render = function render() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", {
        staticClass: "relative inline-block leading-none text-sm text-teal-600 border border-teal-400 py-2"
      }, [_c("select", {
        directives: [{
          name: "model",
          rawName: "v-model",
        ...
        staticClass: "block w-full px-6 pr-8 bg-transparent rounded-md appearance-none cursor-pointer focus:outline-none",
        staticStyle: {
          "width": "144px"
        },
        on: {
      ...
      }, _vm._l(Object.keys(_vm.choices), function(key) {
        return _c("option", {
          key,
          domProps: {
            "value": key
          }
        }, [_vm._v(_vm._s(_vm.choices[key].name))]);
      }), 0), _vm._ssrNode(' <div class="absolute inset-y-0 right-0 flex items-center px-2 pointer-events-none"><svg class="w-5 h-5"><use xlink:href="#chevron-down"></use></svg></div>')], 2);
    };
    var FilterQueuevue_type_template_id_0b5d1d9e_staticRenderFns = [];
    var FilterQueuevue_type_script_lang_js_ = {
      props: {
        choices: {
          type: Object,
          required: true
      ...
      methods: {
        ...
        ...Object(vuex["b"])("summoner", ["championsNotLoaded"])
      }
    };
    var Champions_FilterQueuevue_type_script_lang_js_ = FilterQueuevue_type_script_lang_js_;
    var FilterQueue_component = Object(componentNormalizer["a"])(Champions_FilterQueuevue_type_script_lang_js_, FilterQueuevue_type_template_id_0b5d1d9e_render, FilterQueuevue_type_template_id_0b5d1d9e_staticRenderFns, false, null, null, "2c54a91e");
    var FilterQueue = FilterQueue_component.exports;
    var ChampionsLoadervue_type_template_id_95ed0aa8_render = function render() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", {
    ...
    var ChampionsLoadervue_type_template_id_95ed0aa8_staticRenderFns = [];
    var vue_spinners_common = __webpack_require__(97);
    var ChampionsLoadervue_type_script_lang_js_ = {
      components: {
        SquareLoader: vue_spinners_common["SquareLoader"]
      }
    };
    var Champions_ChampionsLoadervue_type_script_lang_js_ = ChampionsLoadervue_type_script_lang_js_;
    var ChampionsLoader_component = Object(componentNormalizer["a"])(Champions_ChampionsLoadervue_type_script_lang_js_, ChampionsLoadervue_type_template_id_95ed0aa8_render, ChampionsLoadervue_type_template_id_95ed0aa8_staticRenderFns, false, null, null, "21c48256");
    var ChampionsLoader = ChampionsLoader_component.exports;
    var championsvue_type_script_lang_js_ = {
      components: {
        ChampionsTable,
        FilterQueue,
        ChampionsLoader
      ...
      computed: {
        queues() {
          const queues = Object.keys(data["b"]).filter((gameMode) => data["b"][gameMode].type !== "Bot" && this.gamemodes.includes(Number(gameMode))).reduce((obj, key) => {
            return {
              ...obj,
              [key]: data["b"][key]
            };
      ...
      methods: {
        ...
        ...Object(vuex["b"])("summoner", ["championsRequest"])
      },
      head() {
        return {
          title: (this.$store.state.summoner.basic.status === "found" ? `${this.account.name}` : `sss`) + ` - \uC18C\uD658\uC0AC \uCC54\uD53C\uC5B8 \uAE30\uB85D | ${"\uB864 \uC804\uC801 \uAC80\uC0C9 ZEM.GG"}`,
          meta: [{
            hid: "title",
            name: "title",
            content: (this.$store.state.summoner.basic.status === "found" ? `${this.account.name}` : ``) + ` - \uC18C\uD658\uC0AC \uCC54\uD53C\uC5B8 \uAE30\uB85D | ${"\uB864 \uC804\uC801 \uAC80\uC0C9 ZEM.GG"}`
          }, {
            hid: "og:title",
            name: "og:title",
            content: (this.$store.state.summoner.basic.status === "found" ? `${this.account.name}` : ``) + ` - \uC18C\uD658\uC0AC \uCC54\uD53C\uC5B8 \uAE30\uB85D | ${"\uB864 \uC804\uC801 \uAC80\uC0C9 ZEM.GG"}`
            ...
            hid: "og:url",
            property: "og:url",
            content: `https://zem.gg/summoner/${this.$route.params.region}/${this.$route.params.name}/records`
          }],
          link: [{
            rel: "canonical",
            href: `https://zem.gg/summoner/${this.$route.params.region}/${this.$route.params.name}/records`
          }]
        };
      }
    };
    var _name_championsvue_type_script_lang_js_ = championsvue_type_script_lang_js_;
    var champions_component = Object(componentNormalizer["a"])(_name_championsvue_type_script_lang_js_, championsvue_type_template_id_3100687f_render, staticRenderFns, false, null, null, "2b21ba61");
    __webpack_exports__["default"] = champions_component.exports;
  },
