...
var ids = records.ids = [8];
var modules = records.modules = {
  106: function(module, exports2, __webpack_require__) {
    ...
    module.exports.__inject__ = function(context) {
      add("4653b119", content, true, context);
    };
  },
  129: function(module, __webpack_exports__, __webpack_require__) {
    __webpack_require__.r(__webpack_exports__);
    var _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_RecordCard_vue_vue_type_style_index_0_id_10b9b75a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(106);
    for (var __WEBPACK_IMPORT_KEY__ in _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_RecordCard_vue_vue_type_style_index_0_id_10b9b75a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__)
      if (["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0)
        (function(key) {
          __webpack_require__.d(__webpack_exports__, key, function() {
            return _node_modules_unplugin_dist_webpack_loaders_transform_js_ref_34_0_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_36_0_node_modules_vue_style_loader_index_js_ref_5_oneOf_1_0_node_modules_nuxt_postcss8_node_modules_css_loader_dist_cjs_js_ref_5_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_nuxt_postcss8_node_modules_postcss_loader_dist_cjs_js_ref_5_oneOf_1_2_node_modules_vue_loader_lib_index_js_vue_loader_options_node_modules_unplugin_dist_webpack_loaders_transform_js_ref_35_0_RecordCard_vue_vue_type_style_index_0_id_10b9b75a_prod_scoped_true_lang_css___WEBPACK_IMPORTED_MODULE_0__[key];
          });
        })(__WEBPACK_IMPORT_KEY__);
  },
  130: function(module, exports2, __webpack_require__) {
  ...
  160: function(module, __webpack_exports__, __webpack_require__) {
    ...
    var render = function render2() {
      ...
      return _c("div", {
        key: "records"
      }, [!_vm.recordsLoaded || _vm.recordsLoaded && _vm.records.assists ? [_vm._ssrNode('<div class="relative w-full flex flex-col items-start justify-between px-4 py-4 bg-white border border-teal-600 rounded-sm shadow-sm text-teal-600">', "</div>", [_vm._ssrNode('<div class="relative text-2xl">\uC18C\uD658\uC0AC \uCC54\uD53C\uC5B8 \uAE30\uB85D\uC2E4</div> '), _vm._ssrNode('<div class="flex flex-col w-full">', "</div>", [_vm.recordsLoaded ? [_c("RecordCard", {
        attrs: {
          "color": "#63b3ed",
          "text-color": "text-teal-400",
          "border-color": "border-teal-400",
          "record": _vm.records.kda,
          "title": "KDA"
        }
      }), _vm._ssrNode(" "), _c("RecordCard", {
        attrs: {
          "color": "#68D391",
          "text-color": "text-green-500",
          "border-color": "border-green-500",
          "record": _vm.records.kills,
          "title": "\uCD5C\uB300 \uD0AC"
        }
      }), _vm._ssrNode(" "), _c("RecordCard", {
        attrs: {
        ...
        attrs: {
          ...
          "record": _vm.records.damage_dealt_champions,
          "title": "\uCD5C\uB300 \uB51C\uB7C9"
        }
      }), _vm._ssrNode(" "), _c("RecordCard", {
        attrs: {
          ...
          "text-color": "text-blue-500",
          "border-color": "border-teal-500",
          "record": _vm.records.kp,
          "title": "\uCD5C\uB300 \uD0AC\uAD00\uC5EC"
        }
      })] : [_c("RecordLoader")]], 2)], 2)] : _vm._e(), _vm._ssrNode(" " + (_vm.recordsLoaded && !_vm.records.assists ? '<div class="flex flex-col items-center mt-4"><div>No records have been found.</div> <div>\u{1F615}</div></div>' : "<!---->"))], 2);
    };
    var staticRenderFns = [];
    var vuex = __webpack_require__(2);
    var RecordLoadervue_type_template_id_190096d2_render = function render2() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", {
    ...
    var RecordLoadervue_type_template_id_190096d2_staticRenderFns = [];
    var vue_spinners_common = __webpack_require__(97);
    var RecordLoadervue_type_script_lang_js_ = {
      components: {
        SquareLoader: vue_spinners_common["SquareLoader"]
      }
    };
    var Records_RecordLoadervue_type_script_lang_js_ = RecordLoadervue_type_script_lang_js_;
    var componentNormalizer = __webpack_require__(1);
    var component = Object(componentNormalizer["a"])(Records_RecordLoadervue_type_script_lang_js_, RecordLoadervue_type_template_id_190096d2_render, RecordLoadervue_type_template_id_190096d2_staticRenderFns, false, null, null, "45c53024");
    var RecordLoader = component.exports;
    var RecordCardvue_type_template_id_10b9b75a_scoped_true_render = function render2() {
      var _vm = this, _c = _vm._self._c;
      return _c("div", {
        staticClass: "relative w-full flex items-center justify-between px-4 py-2 bg-white border border-teal-600 rounded-sm shadow-sm text-teal-600 mt-4"
      }, [_vm._ssrNode('<div class="flex items-center font-medium leading-4 transition-colors duration-500 ease-in-out border border-transparent rounded-md" data-v-10b9b75a><span' + _vm._ssrClass("w-40 font-bold", _vm.textColor) + " data-v-10b9b75a>" + _vm._ssrEscape(_vm._s(_vm.title)) + '</span> <div class="w-16" data-v-10b9b75a><img' + _vm._ssrAttr("src", `https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default/v1/champion-icons/${_vm.record.champion_id}.png`) + ' alt="Champion Played"' + _vm._ssrClass("block w-full h-16 mx-auto transition duration-500 ease-in transform border-2 rounded-full", [{
        "opacity-0 scale-125": _vm.hover
      }, _vm.borderColor]) + ' data-v-10b9b75a></div> <span class="ml-4 text-4xl"' + _vm._ssrStyle(null, {
        textShadow: `-2px 1px 6px ${_vm.color}`
      }, null) + " data-v-10b9b75a>" + _vm._ssrEscape(_vm._s(_vm.record.champion.name)) + '</span></div> <div class="flex text-4xl" data-v-10b9b75a><div class="w-40 text-right text-4xl"' + _vm._ssrStyle(null, {
        textShadow: `-2px 1px 6px ${_vm.color}`
      }, null) + " data-v-10b9b75a>" + _vm._ssrEscape(_vm._s(_vm.record.amount)) + "</div></div>")]);
    };
    var RecordCardvue_type_template_id_10b9b75a_scoped_true_staticRenderFns = [];
    var data = __webpack_require__(16);
    var functions = __webpack_require__(4);
    var RecordCardvue_type_script_lang_js_ = {
      props: {
        borderColor: {
          type: String,
          required: true
      ...
      methods: {
        timeDifference: functions["e"]
      }
    };
    var Records_RecordCardvue_type_script_lang_js_ = RecordCardvue_type_script_lang_js_;
    function injectStyles(context) {
      var style0 = __webpack_require__(129);
      if (style0.__inject__)
        style0.__inject__(context);
    }
    var RecordCard_component = Object(componentNormalizer["a"])(Records_RecordCardvue_type_script_lang_js_, RecordCardvue_type_template_id_10b9b75a_scoped_true_render, RecordCardvue_type_template_id_10b9b75a_scoped_true_staticRenderFns, false, injectStyles, "10b9b75a", "37701ee1");
    var RecordCard = RecordCard_component.exports;
    var recordsvue_type_script_lang_js_ = {
      components: {
        RecordLoader,
        RecordCard
      },
      ...
      methods: {
        ...
        ...Object(vuex["b"])("summoner", ["recordsRequest"])
      },
      head() {
        return {
    ...
    var _name_recordsvue_type_script_lang_js_ = recordsvue_type_script_lang_js_;
    var records_component = Object(componentNormalizer["a"])(_name_recordsvue_type_script_lang_js_, render, staticRenderFns, false, null, null, "442ec879");
    __webpack_exports__["default"] = records_component.exports;
  },
