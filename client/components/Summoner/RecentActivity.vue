<template>
  <div>
    <div class="inline-block bg-teal-800 rounded-lg">
      <div
        class="relative flex items-center justify-center py-2 text-teal-200 rounded-t-lg heading"
      >
        <svg class="w-4 h-4">
          <use xlink:href="#time" />
        </svg>
      ...
      <div class="p-3 pt-1">
        <div class="flex">
          <span class="ml-12 text-xs font-semibold text-teal-200">{{ gridDays[11].month }}</span>
          <span class="ml-16 text-xs font-semibold text-teal-200">{{ gridDays[42].month }}</span>
          <span class="ml-16 text-xs font-semibold text-teal-200">{{ gridDays[73].month }}</span>
          <span class="ml-16 text-xs font-semibold text-teal-200">{{ gridDays[104].month }}</span>
        </div>
        <div class="flex mt-1">
          <div class="flex flex-col">
            <span class="text-xs font-semibold leading-snug text-teal-200">Mo</span>
            <span class="mt-1 text-xs font-semibold leading-snug text-teal-200">Tu</span>
            <span class="mt-1 text-xs font-semibold leading-snug text-teal-200">We</span>
            <span class="mt-1 text-xs font-semibold leading-snug text-teal-200">Th</span>
            <span class="mt-1 text-xs font-semibold leading-snug text-teal-200">Fr</span>
            <span class="mt-1 text-xs font-semibold leading-snug text-teal-200">Sa</span>
            <span class="mt-1 text-xs font-semibold leading-snug text-teal-200">Su</span>
          </div>
          <div
