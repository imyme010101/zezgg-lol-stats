    ...
    <div class="mt-24 space-y-4">
      ...
      >
                ...
                <li
                  ...
                  :class="
                    selectedRunes.selected.includes(runeId)
                      ...
                      : 'not-used-rune'
                  "
                  class="w-12 h-12 bg-center bg-cover border-2 border-teal-600 rounded-full cursor-pointer"
                ></li>
              </template>
              <template #default>
                <div
                ...
                >
                  ...
                  <div class="ml-2 leading-none">
                    ...
                    <div
                      ...
                      class="mt-3 font-light leading-tight text-teal-200 rune-description"
                    ></div>
                  </div>
                </div>
              </template>
        ...
        <div
          ...
          class="w-full mt-4 bg-teal-500 bg-opacity-25 h-2px"
        ></div>
      </div>
                  ...
                  <li
                    ...
                    :class="
                      selectedRunes.selected[index + 6] === kStat
                        ...
                        : 'not-used-rune'
                    "
                    class="w-8 h-8 bg-teal-900 bg-center bg-cover border-2 border-teal-600 rounded-full cursor-pointer"
                  ></li>
                </template>
                <template #default>
                  <div
                  ...
                  >
                    <div
                      ...
                      class="flex-shrink-0 w-8 h-8 ml-1 bg-center bg-cover rounded-md bg-white0"
                    ></div>
                    <div class="ml-2 leading-none">
